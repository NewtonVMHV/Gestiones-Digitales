...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><a href="{{ route('diputados.index') }}"><i class='bx bx-chevron-left-circle'></i></a> Crear Diputado </h1>
</div>
@if ($errors->any())
...
@endif
<form action="{{ route('diputados.store') }}" method="post">
    @csrf
    <div class="row mb-3">
        <div class="col">
            <label for="Legislatura" class="form-label is-required">Legislatura</label>
            <input type="text" class="form-control" id="Legislatura" name="Legislatura" required>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" id="ApellidoDL" name="ApellidoDl" required>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col">
    ...
    <div class="d-grid gap-2">
        <button type="submit" class="btn btn-primary">Agregar Diputado</button>
